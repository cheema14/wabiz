...
class Slim {
    ...
    private static function parseInput($value) {
        ...
        // If magic quotes enabled (commented out since is no longer used in newer PHP versions, if you're on a very old version you can uncommented the next three lines)
    ...
    public static function saveFile($data, $name, $path , $uid = false) {
